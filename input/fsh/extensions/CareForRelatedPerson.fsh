...
* extension[gender].value[x] ^binding.valueSet = "https://terminology.medcore.uz/ValueSet/gender"
* extension[gender-other].value[x] only CodeableConcept
* extension[gender-other].value[x] ^binding.valueSet = "https://terminology.medcore.uz/ValueSet/gender-other-vs"

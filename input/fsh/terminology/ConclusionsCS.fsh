...
* ^url = "https://terminology.dhp.uz/fhir/integrations/CodeSystem/conclusions-cs"
* ^status = #active
* ^content = #complete
* ^caseSensitive = true
...
* #emdoc-0008-0002 "Nogironligi bo‘lgan shaxs sifatida aniqlangan (I guruh)"
  ...
  * ^designation[+].language = #ru
  * ^designation[=].value = "Идентифицирован как человек с инвалидностью (Группа I)"
* #emdoc-0008-0003 "Nogironligi bo‘lgan shaxs sifatida aniqlangan (II guruh)"
  ...
  * ^designation[+].language = #ru
  * ^designation[=].value = "Идентифицирован как человек с инвалидностью (Группа II)"
* #emdoc-0008-0004 "Nogironligi bo‘lgan shaxs sifatida aniqlangan (III guruh)"
  ...
  * ^designation[+].language = #ru
  * ^designation[=].value = "Идентифицирован как человек с инвалидностью (Группа III)"
